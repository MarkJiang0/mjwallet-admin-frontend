export default {
  ...
  // account
  'pages.wallet.account.form.name': '账户名称',
  'pages.wallet.account.form.username': '用户名称',
  'pages.wallet.account.form.id': 'ID',
  'pages.wallet.account.form.address': '地址',
  'pages.wallet.account.form.balance': '余额',
  'pages.wallet.account.form.usdtbalance': 'usdt余额',
  //transaction
  'pages.wallet.transaction.form.from_address': '发送地址',
  'pages.wallet.transaction.form.to_address': '接受地址',
  'pages.wallet.transaction.form.amount': '金额',
  'pages.wallet.transaction.form.coin': 'Token',
  'pages.wallet.transaction.form.status': '交易状态',
  'pages.wallet.transaction.form.confirm_status': '确认状态',
  'pages.wallet.transaction.form.status.success': '成功',
  'pages.wallet.transaction.form.status.failed': '失败',
  'pages.wallet.transaction.form.status.confirmed': '已确认',
  'pages.wallet.transaction.form.status.unconfirmed': '未确认',
  //bot
  'pages.wallet.bot.form.name': '名称',
  'pages.wallet.bot.form.status': '状态',
  'pages.wallet.bot.form.status.enable': '启用',
  'pages.wallet.bot.form.status.disable': '禁用',
};
